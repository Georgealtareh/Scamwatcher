      ...
      <header className="bg-primary text-white p-4 shadow-md">
        <div className="max-w-container mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:block">
            <ul className="flex gap-6 font-semibold text-sm uppercase tracking-wider">
              <li><a href="#" className="hover:text-warning transition-colors">Feed</a></li>
              <li><a href="#" className="hover:text-warning transition-colors">Alerts</a></li>
              <li><a href="#" className="hover:text-warning transition-colors">About</a></li>
            </ul>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-container mx-auto grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="grid gap-3 text-sm">
              <li><a href="#" className="hover:text-white transition-colors">Browse Scam Feed</a></li>
